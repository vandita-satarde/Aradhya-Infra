...
function OurStory() {
  return (
    ...
    <div className=' bg-[#F3ECDC] p-12 md:p-30'>
                    ...
                    <p className='text-[26px] md:text-[45px] text-[#2D2D2D] font-bold font-[abril] my-5 md:my-8 md:mr-70 '>Building dreams, creating communities”—that’s not just a tagline—it’s why Aradhya Infra exists.</p>
                    <p className=' text-[#6E6E6E] text-[13px] md:text-[18px] '>Rooted in Nagpur, committed to transparency, fueled by innovation, and motivated by community-first principle, we design homes that stand the test of time—where every address becomes a legacy.</p>

                    <div className='flex flex-col lg:flex-row gap-6 mt-10 font-[abril]'>
                      <div className='w-full md:w-1/2 bg-[#F9F9F9] rounded-4xl p-5 md:p-10 shadow-2xs '>
                        <p className='font-semibold text-[#2D2D2D] text-[20px] md:text-[25px] '>Growth Anchored in Vision</p>
                        <hr className='my-3 md:my-8'/>
                        <div className='flex flex-col gap-6 md:gap-10 font-[abril] '>
                          <div className='flex gap-3 md:gap-8'>
                          <p className='text-[26px] md:text-[40px] font-bold text-[#048886] '>01</p>
                          <div>
                            <p className='text-[18px] md:text-[21px] font-bold text-[#2D2D2D]'>Local roots</p>
                            <p className='text-[14px] md:text-[18px] font-sans text-[#6E6E6E]'>Nagpur-based, with deep knowledge of local climate, culture, and city planning needs.</p>
                          </div>                          
                          </div>
                          <div className='flex gap-3 md:gap-8'>
                          <p className='text-[26px] md:text-[40px] font-bold text-[#048886] '>02</p>
                          <div>
                            <p className='text-[18px] md:text-[21px] font-bold text-[#2D2D2D] '>RERA & Compliance certified</p>
                            <p className='text-[14px] md:text-[18px] font-sans text-[#6E6E6E]'>Every project meets legal standards and quality benchmarks.</p>
                          </div>                          
                          </div>
                          <div className='flex gap-3 md:gap-8'>
                          <p className='text-[26px] md:text-[40px] font-bold text-[#048886] '>03</p>
                          <div>
                            <p className='text-[18px] md:text-[21px] font-bold text-[#2D2D2D] '>Sustained development</p>
                            <p className='text-[14px] md:text-[18px] font-sans text-[#6E6E6E]'>A holistic township with infrastructure—for roads, water, electrification, drainage, and green spaces—delivered through thoughtful planning.</p>
                          </div>                          
                          </div>
                        </div>
                      </div>              

                      <div className='w-full lg:w-1/2 bg-[#F9F9F9] rounded-4xl p-5 md:p-10 shadow-2xs'>
                        <p className='italic font-semibold text-[18px] md:text-[22px] py-3 md:py-9 '>“ Our Story – Aradhya Infra “</p>
                        <p className='text-[14px] md:text-[18px] font-sans '>
                    ...
                    <div className=' pt-17 md:pt-37'>
                      <p className='text-[#048886] text-[13px] md:text-[15px] '>WHERE WE ARE TODAY & BEYOND</p>
                      <p className='text-[29px] md:text-[45px] text-[#2D2D2D] font-bold font-[abril] mt-3 mb-7 md:mb-14 '>Where We Are Today & Beyond</p>
                      <ul className='list-disc font-semibold font-sans text-[14px] md:text-[22px] flex flex-col gap-5 md:gap-12'>
