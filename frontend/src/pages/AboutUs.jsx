    ...
    <>
      ...
      <div className='relative gap-10 bg-[#F3ECDC] px-5 md:px-30 py-5 md:py-22'>
        <StoryandBelief 
          ...
          subtitle2='" About Us - Aradhya Infra "'
          subtitle2content='At Aradhya Infra, we don’t just build homes—we build communities, trust, and long-term value. Founded with a vision to redefine urban living in Central India, we are committed to crafting thoughtfully planned residential and township developments that offer comfort, sustainability, and peace of mind.
