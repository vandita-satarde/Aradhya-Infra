  ...
  return (
    <>
      <div className=''>
        ...
        <div>
          {/* Images */}
          <div className=' flex flex-col md:flex-row justify-center items-center gap-5 md:gap-10 py-5 md:py-15 bg-white relative'>
            <img
            ...
            <div className="flex flex-row md:flex-col gap-2 md:gap-5 overflow-x-auto md:overflow-y-auto scrollbar-thin scrollbar-rounded-xl shadow-inner shadow-gray-400 p-3 md:p-5 rounded-2xl max-h-[413px] w-[300px] md:w-auto">
              {project.images &&
          ...
          <div className='px-5 md:px-28 py-8 md:py-15 text-[#073937]'>
            <p className='text-[26px] md:text-[40px] font-[abril] font-bold '>{project.title} </p>
            <div className='flex flex-col md:flex-row gap-6 md:gap-40 '>
              <div className='md:w-1/2'>
                ...
                <p className='text-[12px] md:text-[17.44px] '>
                  {project.description}
                </p>
              </div>
              <div className='md:w-1/2'>
                ...
                <a href='/enquiry'>
                  <button className='mt-10 text-[14px] md:text-[18px] w-[130px] md:w-[590px] h-[40px] md:h-[60px] bg-black text-[#F3ECDC] cursor-pointer '>ENQUIRY</button>
                </a>
              </div>
            </div>
          </div>
