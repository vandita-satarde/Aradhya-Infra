...
function GetStarted() {
  return (
    <div className='relative py-8 md:py-16 lg:py-20 px-3 md:px-8 lg:px-12 bg-[#E6FFFF] overflow-hidden'>
      <div className='relative rounded-[30px] lg:rounded-4xl overflow-hidden max-w-7xl mx-auto'>
        ...
        <div className='absolute inset-0 flex flex-col justify-center items-center text-white text-center p-6 md:p-12 lg:p-16'>
          <h2 className='text-[18px] md:text-3xl lg:text-4xl xl:text-[60px] text-[#E6FFFF] font-bold font-[abril] leading-tight md:mb-6 lg:mb-8'>
          ...
          <Link 
            to="/contact"
            className='bg-teal-600 hover:bg-teal-700 text-[10px] md:text-[15px] font-sans text-[#E6FFFF] py-2 md:py-4 px-6 md:px-10 rounded-[30px] lg:rounded-4xl transition-colors duration-300 font-medium'
          >
            GET STARTED
          </Link>
        </div>
