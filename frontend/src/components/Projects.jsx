    ...
    <>
      <div className=" text-center mt-18 mb-20">
        ...
        <div className="flex gap-12 justify-center text-[17px] ">
          <button className=" border py-4 px-12 bg-black text-white ">
            All PROPERTIES
          </button>
          <button className=" border py-4 px-12 ">COMMERCIAL</button>
          <button className=" border py-4 px-12 ">TOWNSHIP</button>
        </div>
        <br />
        <br />
        <br />
        ...
        <div className="flex gap-10 justify-center">
          <div className="relative w-[400px] border-2 ">
            <p className="absolute bg-gray-100 py-0.5 px-4 m-3 rounded ">
              Under Construction
            </p>
            <img src={image01} />
            <div className=" flex flex-col items-start m-8 text-[19px] ">
              ...
              <div className="text-[17px] flex gap-6">
                <button className=" py-2 px-7 bg-black text-white ">
                  BOOK
                </button>
