...
function PropertyCard() {
  return (
    <>
      <div className='w-full md:w-[1241px] mx-auto flex flex-col md:flex-row shadow-lg rounded-2xl overflow-hidden  '>
              <img src={image01} className='w-full md:w-[480px] md:h-[288px] rounded-2xl object-cover m-1' />
              <div className='flex flex-col md:flex-row justify-between md:ml-10 gap-10 md:gap-32 w-full '>
                <div className='text-[15px] text-[#048886] p-2'>
                  ...
                  <div className='text-[13px] flex flex-wrap gap-2 my-4 '>
                ...
                <div className='flex flex-col md:items-end px-2'>
                  <p className='text-[20px] md:text-[23px] text-[#9C1E15] '>Rp. 500.000</p>
