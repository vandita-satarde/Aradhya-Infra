  ...
  <div className="relative h-[860px] md:h-[950px] lg:h-[930px] bg-opacity-80 bg-black font-sans overflow-hidden">
      ...
      <div className='flex flex-col md:flex-row justify-around text-[#F3ECDC] font-[abril] font-bold gap-8 md:gap-10 px-6 text-center'>
        <div>
          ...
          <p className='text-[15px] md:text-[18px] lg:text-[21px]'>YEARS OF LEGACY</p>
        </div>
        <div>
          <p className='text-[30px] md:text-[35px] lg:text-[45px]'>15th</p>
          <p className='text-[15px] md:text-[18px] lg:text-[21px]'>SQ.FT.UNDER PLANNING & DEVELOPMENT</p>
        </div>
        <div>
          <p className='text-[30px] md:text-[35px] lg:text-[45px]'>56</p>
          <p className='text-[15px] md:text-[18px] lg:text-[21px]'>LANDMARKS</p>
        </div>
      </div>
        </div>
      </div>
