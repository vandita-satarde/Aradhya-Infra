    ...
    <div className='bg-black font-sans px-4 md:px-6 lg:px-12 xl:px-30 pt-8 lg:pt-10'>
      <div className='flex flex-col md:flex-row md:gap-10 lg:gap-20 mb-12 md:mb-20'>
        ...
        <div className='md:w-[200px] lg:w-1/4'>
          <img src={logo} className='h-20 w-20 lg:h-28 lg:w-28 mb-4 md:mb-6' alt="Aradhya Infra logo" />
        ...
        <div className=' lg:w-3/4 flex flex-col md:flex-row gap-8 md:gap-6 lg:gap-30 text-[14px] md:text-[12px] lg:text-[18px] mt-15 '>
          {/* Quick Links */}
          <div className=''>
            <h3 className='font-bold font-[abril] text-[#F3ECDC] text-[15px] md:text-[16px] lg:text-[25px] mb-2 md:mb-4 lg:mb-6'>Quick Links</h3>
            <div className='flex flex-col gap-2 lg:gap-5 text-[#FFFFFFBF]'>
              <Link to="/" className='flex items-center gap-2 lg:gap-4 hover:text-white transition-colors duration-200'>
                <img src={arrow} alt="arrow" className='h-2 md:h-3 lg:h-3.5 ' /> Home
              </Link>
              <Link to="/about" className='flex items-center gap-2 lg:gap-4 hover:text-white transition-colors duration-200'>
                <img src={arrow} alt="arrow" className='h-2 md:h-3 lg:h-3.5 ' /> About Us
              </Link>
              <Link to="/story" className='flex items-center gap-2 lg:gap-4 hover:text-white transition-colors duration-200'>
                <img src={arrow} alt="arrow" className='h-2 md:h-3 lg:h-3.5 ' /> Our Story
              </Link>
              <Link to="/projects" className='flex items-center gap-2 lg:gap-4 hover:text-white transition-colors duration-200'>
                <img src={arrow} alt="arrow" className='h-2 md:h-3 lg:h-3.5 ' /> Our Projects
              </Link>
            </div>
          </div>
          ...
          <div className='lg:w-70'>
            <h3 className='font-bold text-[#F3ECDC] font-[abril] text-[15px] md:text-[16px] lg:text-[25px] mb-2 md:mb-4 lg:mb-6'>Location, Contact</h3>
            <div className='flex flex-col gap-3 md:gap-4 lg:gap-5 text-[#FFFFFFBF]'>
              <div className='flex gap-3 lg:gap-4'>
                <img src={icon01} alt="location" className='h-3.5 md:h-4 lg:h-5 mt-1' />
          ...
          {/* Other Links */}
          <div className=''>
            <h3 className='font-bold text-[#F3ECDC] font-[abril] text-[15px] md:text-[16px] lg:text-[25px] mb-2 md:mb-4 lg:mb-6'>Other Links</h3>
            <div className='flex flex-col gap-2 md:gap-4 lg:gap-5 text-[#FFFFFFBF]'>
              <div className='flex items-center gap-2 lg:gap-4 cursor-pointer hover:text-white transition-colors duration-200'>
                <img src={arrow} alt="arrow" className='h-2 md:h-3 lg:h-3.5 ' /> Terms & Conditions
              </div>
              <div className='flex items-center gap-2 lg:gap-4 cursor-pointer hover:text-white transition-colors duration-200'>
                <img src={arrow} alt="arrow" className='h-2 md:h-3 lg:h-3.5 ' /> Privacy Policy
              </div>
              <div className='flex items-center gap-2 lg:gap-4 cursor-pointer hover:text-white transition-colors duration-200'>
                <img src={arrow} alt="arrow" className='h-2 md:h-3 lg:h-3.5 ' /> Cookies Policy
              </div>
            </div>
          </div>
        </div>
