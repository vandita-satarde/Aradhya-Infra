      ...
      <div className='flex flex-col lg:flex-row gap-8 lg:gap-12 max-w-7xl mx-auto'>
        ...
        <div className='w-full lg:w-2/3'>
          ...
          <div className='flex flex-col md:flex-row gap-6 md:gap-8'>
            {/* Image */}
            <div className='bg-[#F3ECDC] md:w-[300px] lg:w-[380px] p-3 rounded-[20px] md:rounded-[30px] mx-auto md:mx-0'>
              <img src={image01} className=' h-[250px] md:h-[300px] lg:h-[350px] rounded-[20px] md:rounded-[30px] object-cover' alt="testimonial" />
            </div>
